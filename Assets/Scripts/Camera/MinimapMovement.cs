...
public class MinimapMovement : MonoBehaviour, IPointerDownHandler
{
    ...
    private void MoveCamera()
    {
        ...
        if (!RectTransformUtility.ScreenPointToLocalPointInRectangle(minimapRect, mousePos, null, out Vector2 localPoint)) { return; } // check if mouse position is inside the minimap
